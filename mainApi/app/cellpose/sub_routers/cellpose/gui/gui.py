...
def run():
    ...
    if not icon_path.is_file():
        ...
        download_url_to_file('https://www.cellpose.org/static/images/cellpose_transparent.png', icon_path,
                             progress=True)
...
class MainW(QMainWindow):
    ...
    def suggest_model(self, model_name=None):
        ...
        train_styles, train_labels, label_models = styles_gt['train_styles'], styles_gt['leiden_labels'], styles_gt[
            'label_models']
        self.diameter = float(self.Diameter.text())
